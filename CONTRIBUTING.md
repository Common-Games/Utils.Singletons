...
1. Make an [Issue](https://github.com/Common-Games/Utilities.Singletons/issues/new)
...
```json
    {
        "dependencies": {
            "com.Common-Games.Utilities.Singletons": "https://github.com/YOUR_USER/Utilities.Singletons.git"
        }
    }
```
...
reported to the community leaders responsible for enforcement at walterhulsebos@outlook.com.
